...
public class Audio {
    ...
    public Audio(Long id, Locale locale, Calendar timeLastUpdate, Integer revisionNumber, ContentStatus contentStatus, String fileUrl, Integer fileSize, String contentType, String attributionUrl, Set literacySkills, Set numeracySkills, String transcription, AudioFormat audioFormat) {
        this.id = id;
        this.locale = locale;
