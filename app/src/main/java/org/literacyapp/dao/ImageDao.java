...
public class ImageDao extends AbstractDao<Image, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ImageFormat = new Property(9, String.class, "imageFormat", false, "IMAGE_FORMAT");
    ...
    public Image readEntity(Cursor cursor, int offset) {
        Image entity = new Image( //
            ...
            imageFormatConverter.convertToEntityProperty(cursor.getString(offset + 9)), // imageFormat
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10) // dominantColor
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Image entity, int offset) {
        ...
        entity.setImageFormat(imageFormatConverter.convertToEntityProperty(cursor.getString(offset + 9)));
        entity.setDominantColor(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
     }
