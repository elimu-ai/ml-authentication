...
import org.literacyapp.dao.converter.ImageTypeConverter;
...
public class ImageDao extends AbstractDao<Image, Long> {
    ...
    */
    ...
    private final ImageTypeConverter imageTypeConverter = new ImageTypeConverter();
    ...
    protected void bindValues(SQLiteStatement stmt, Image entity) {
        ...
        if (imageType != null) {
            stmt.bindString(3, imageTypeConverter.convertToDatabaseValue(imageType));
        }
    ...
    public Image readEntity(Cursor cursor, int offset) {
        Image entity = new Image( //
            ...
            cursor.isNull(offset + 2) ? null : imageTypeConverter.convertToEntityProperty(cursor.getString(offset + 2)), // imageType
    ...
    public void readEntity(Cursor cursor, Image entity, int offset) {
        ...
        entity.setImageType(cursor.isNull(offset + 2) ? null : imageTypeConverter.convertToEntityProperty(cursor.getString(offset + 2)));
