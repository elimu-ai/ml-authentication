...
public class Video {
    ...
    public Video(Long id, Locale locale, Calendar timeLastUpdate, Integer revisionNumber, ContentStatus contentStatus, String fileUrl, Integer fileSize, String contentType, String attributionUrl, Set literacySkills, Set numeracySkills, String title, VideoFormat videoFormat) {
        this.id = id;
        this.locale = locale;
